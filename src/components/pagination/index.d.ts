...
export * from "./pagination-prev-button.svelte";
export * from "./pagination-next-button.svelte";
...
export { default as PaginationNextButton } from "./pagination-next-button.svelte";
