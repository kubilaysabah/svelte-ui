<script lang="ts">
	...
	import {
		RangeCalendarMonths as Months,
		RangeCalendarNav as Nav,
		RangeCalendarPrevButton as PrevButton,
		RangeCalendarNextButton as NextButton,
		RangeCalendarMonth as Month,
		RangeCalendarHeader as Header,
		RangeCalendarCaption as Caption,
		RangeCalendarGrid as Grid,
		RangeCalendarGridRow as GridRow,
		RangeCalendarHeadCell as HeadCell,
		RangeCalendarGridBody as GridBody,
		RangeCalendarCell as Cell,
		RangeCalendarDay as Day,
		RangeCalendarGridHead as GridHead
	} from './index.js';
	const RangeCalendar = {
		Months,
		Nav,
